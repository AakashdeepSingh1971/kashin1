    ...
    <div className="min-h-screen bg-kashin-cream">
      ...
      <main className="pt-24 md:pt-32 pb-16 md:pb-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12">
          {/* Hero Section */}
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center mb-16 md:mb-20">
            <div className="text-center md:text-left order-2 md:order-1">
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-kashin-brown mb-4 md:mb-6">
                ABOUT US
              </h1>
            ...
            <div className="relative order-1 md:order-2">
              <Link href="/founder" className="block group">
                <div className="aspect-[4/5] sm:aspect-[3/4] md:aspect-[4/5] rounded-2xl overflow-hidden shadow-lg max-w-sm mx-auto md:max-w-none">
                  <Image fill
                ...
                <div className="absolute bottom-4 left-1/2 -translate-x-1/2 md:left-4 md:right-4 md:translate-x-0 bg-kashin-cream/90 backdrop-blur-sm rounded-lg p-3 md:p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-[calc(100%-2rem)] max-w-sm md:max-w-none md:w-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-8 md:gap-12 mb-16 md:mb-20">
            <div className="text-center sm:text-left">
              <h2 className="font-display text-xl sm:text-2xl md:text-3xl text-kashin-brown mb-3 md:mb-4">
                Who We Are
              </h2>
          ...
          {/* Why Choose Us */}
          <div>
            <h2 className="font-display text-xl sm:text-2xl md:text-3xl text-kashin-brown mb-6 md:mb-8 text-center sm:text-left">
              Why Choose Us?
            </h2>
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start text-center sm:text-left">
                ...
                <div>
                  <h3 className="font-display text-lg md:text-xl text-kashin-brown mb-1 md:mb-2">Expertise</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start text-center sm:text-left">
                ...
                <div>
                  <h3 className="font-display text-lg md:text-xl text-kashin-brown mb-1 md:mb-2">Integrity</h3>
                  <p className="text-kashin-brown/60 text-xs sm:text-sm leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center sm:items-start text-center sm:text-left sm:col-span-2 md:col-span-1 sm:max-w-xs sm:mx-auto md:max-w-none">
                ...
                <div>
                  <h3 className="font-display text-lg md:text-xl text-kashin-brown mb-1 md:mb-2">Results</h3>
                  <p className="text-kashin-brown/60 text-xs sm:text-sm leading-relaxed">
